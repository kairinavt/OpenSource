        ...
        <div class="card-header py-3 row">
          ...
          <h5 class="mb-0 text-left" id="">
           ...
           <div class="col-sm-9 text-right">
	             ...
	             <form action="xuatExcelCategoryControl" method="get"> 
              ...
              <tbody>
                <c:forEach items="${listCC}" var="o">
                		<tr>
                  			...
                  			<td>${o.cname}</td> 
                   		<td>
                     	<a href="deleteCategory?id=${o.cid}"><button type="button" class="btn btn-danger"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></button></a>
                   		</td> 
                		</tr>
                 </c:forEach>
